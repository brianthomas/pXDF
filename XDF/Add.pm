...
# /** COPYRIGHT
#    Add.pm Copyright (C) 2003 Brian Thomas,
...
# /** DESCRIPTION
# An XDF::Add is a class that defines an addition component for an XDF::Conversion object.
# */
...
# This method returns the class node name of XDF::Add.
# */
...
XDF::Add inherits class and attribute methods of L<XDF::GenericObject>, L<XDF::ConversionComponent>, L<XDF::BaseObject>.
...
The following methods are defined for the class XDF::Add.

=over 4

=item classXMLNodeName (EMPTY)

This method takes no arguments may not be changed. This method returns the class node name of XDF::Add.  
...
The following instance (object) methods are defined for XDF::Add.
...
XDF::Add inherits the following instance (object) methods of L<XDF::GenericObject>:
B<clone>, B<update>.
...
XDF::Add inherits the following instance (object) methods of L<XDF::BaseObject>:
