...
# /** DESCRIPTION
# The XDF::BinaryIntegerDataFormat class describes the data format of objects which 
...
# inherits from XDF::DataFormat and XDF::BinaryIntegerStyle
# order in @ISA array is important (?)
@ISA = ("XDF::BinaryIntegerStyle","XDF::DataFormat");

# CLASS DATA
my $Class_XML_Node_Name = &XDF::DataFormat::classXMLNodeName . "||" .
                          &XDF::BinaryIntegerStyle::classXMLNodeName; 

my @Class_Attributes = qw (
                          );

# add in super class attributes (multiple inheritance here!) 
push @Class_Attributes, @{&XDF::DataFormat::classAttributes};
push @Class_Attributes, @{&XDF::BinaryIntegerStyle::classAttributes};
...
=head1 DESCRIPTION
 ...
 The XDF::BinaryIntegerDataFormat class describes the data format of objects which  require such description (XDF::Field, XDF::Array). 

XDF::BinaryIntegerDataFormat inherits class and attribute methods of L<XDF::GenericObject>, L<XDF::BinaryIntegerStyle>, L<XDF::Object>.
...
XDF::BinaryIntegerDataFormat inherits the following instance methods of L<XDF::BinaryIntegerStyle>:
B<bytes>.
...
XDF::BinaryIntegerDataFormat inherits the following instance methods of L<XDF::Object>:
...
L< XDF::Array>, L< XDF::BinaryIntegerStyle>, L< XDF::DataFormat>, L< XDF::Field>, L<XDF::BinaryIntegerStyle>, L<XDF::DataFormat>
