...
# Package for XDF::ColAxis
# $Id$

# /** COPYRIGHT
#    ColAxis.pm Copyright (C) 2002 Brian Thomas,
...
# /** SYNOPSIS
# 
#    my $axisObj = new XDF::ColAxis(); # create axis, size '1'
...
#    or 
#
#    my $axisObj = new XDF::ColAxis(10); # create axis wi/ length 10 and 10 values numbered 0 thru 9. 
#
#    or 
# 
#    my @axisValueList = qw ( $axisValueObjRef1 $axisValueObjRef2 );
#    my $axisObj = new XDF::ColAxis( { 'name' => 'first axis',
#                                 }
#                               );
#
# */
...
# CLASS DATA
my $DEFAULT_COL_AXIS_ID = "colAxis";
my $Class_XML_Node_Name = "colAxis";
...
# /** classXMLNodeName
# This method returns the class node name for XDF::ColAxis; 
...
sub setAxisId {
   my ($self, $value) = @_;
   error("not allowed to set axisId for ColAxis");
#   $self->{axisId} = $value;
}
...
XDF::ColAxis - Perl Class for ColAxis
...
XDF::ColAxis inherits class and attribute methods of L<XDF::Axis>, L<XDF::BaseObjectWithXMLElementsAndValueList>, L< = (>.
...
The following methods are defined for the class XDF::ColAxis.

=over 4

=item classXMLNodeName (EMPTY)

This method returns the class node name for XDF::ColAxis; This method takes no arguments may not be changed.  
...
The following instance (object) methods are defined for XDF::ColAxis.
...
XDF::ColAxis inherits the following instance (object) methods of L<XDF::Axis>:
