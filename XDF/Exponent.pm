...
# /** COPYRIGHT
#    Exponent.pm Copyright (C) 2003 Brian Thomas,
...
# /** DESCRIPTION
# An XDF::Exponent is a class that defines an exponent component for an XDF::Conversion object.
# */
...
# This method returns the class node name of XDF::Exponent.
# */
...
XDF::Exponent - Perl Class for Exponent
...
XDF::Exponent inherits class and attribute methods of L<XDF::GenericObject>, L<XDF::ConversionComponent>, L<XDF::BaseObject>.
...
The following methods are defined for the class XDF::Exponent.

=over 4

=item classXMLNodeName (EMPTY)

This method takes no arguments may not be changed. This method returns the class node name of XDF::Exponent.  
...
The following instance (object) methods are defined for XDF::Exponent.
...
XDF::Exponent inherits the following instance (object) methods of L<XDF::GenericObject>:
B<clone>, B<update>.
...
XDF::Exponent inherits the following instance (object) methods of L<XDF::BaseObject>:
