...
package XDF::ExponentDataFormat;

# /** COPYRIGHT
#    ExponentDataFormat.pm Copyright (C) 2000 Brian Thomas,
...
# /** DESCRIPTION
# The XDF::ExponentDataFormat class describes the data format of objects which 
...
# inherits from XDF::DataFormat and XDF::ExponentStyle
# order in @ISA array is important (?)
@ISA = ("XDF::ExponentStyle","XDF::DataFormat");

# CLASS DATA
my $Class_XML_Node_Name = &XDF::DataFormat::classXMLNodeName . "||" .
                          &XDF::ExponentStyle::classXMLNodeName;
...
push @Class_Attributes, @{&XDF::ExponentStyle::classAttributes};
...
XDF::ExponentDataFormat - Perl Class for ExponentDataFormat
...
A change in the value of these class attributes will change the value for ALL instances of XDF::ExponentDataFormat.
...
L< XDF::Array>, L< XDF::DataFormat>, L< XDF::ExponentStyle>, L< XDF::Field>, L<XDF::ExponentStyle>, L<XDF::DataFormat>
