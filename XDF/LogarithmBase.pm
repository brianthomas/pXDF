...
# /** COPYRIGHT
#    LogarithmBase.pm Copyright (C) 2003 Brian Thomas,
...
# /** DESCRIPTION
# An XDF::LogarithmBase is a class that defines an logarithm with arbritrary base 
# component for an XDF::Conversion object.
# */
...
# This method returns the class node name of XDF::LogarithmBase.
# */
