...
XDF::Multiply - Perl Class for Multiply
...
XDF::Multiply inherits class and attribute methods of L<XDF::GenericObject>, L<XDF::ConversionComponent>, L<XDF::BaseObject>.
...
The following methods are defined for the class XDF::Multiply.

=over 4

=item classXMLNodeName (EMPTY)

This method takes no arguments may not be changed. This method returns the class node name of XDF::Multiply.  
...
The following instance (object) methods are defined for XDF::Multiply.
...
XDF::Multiply inherits the following instance (object) methods of L<XDF::GenericObject>:
B<clone>, B<update>.
...
XDF::Multiply inherits the following instance (object) methods of L<XDF::BaseObject>:
