...
# /** COPYRIGHT
#    Object.pm Copyright (C) 2000 Brian Thomas,
...
#@
#@
# XDF::Object is the base class that all other XDF object classes inherit from.
# It supplies general use methods to these sub classes. (Diagram of object structure??) 
#@ 
#@
# All other XDF objects inherit the methods of XDF::Object.
# */
...
#  of the class attributes for XDF::Object;
  ...
  if ($#objList > -1 or defined $objPCDATA or defined $noChildObjectNodeName) {
    ...
    for (@objList) { 
      ...
      if (ref($_) =~ m/ARRAY/ ) { # if its a list..
        ...
        die "Object.pm got weird reference: $_\n";
...
XDF::Object - Perl Class for Object
...
=head1 DESCRIPTION
 ...
 XDF::Object is the base class that all other XDF object classes inherit from.  It supplies general use methods to these sub classes. (Diagram of object structure??)   
 
 All other XDF objects inherit the methods of XDF::Object. 

XDF::Object inherits class and attribute methods of L<XDF::GenericObject>.
...
A change in the value of these class attributes will change the value for ALL instances of XDF::Object.

=over 4

=item classAttributes (EMPTY)

This method returns a list reference containing the namesof the class attributes for XDF::Object;This method takes no arguments may not be changed.  
...
XDF::Object inherits the following instance methods of L<XDF::GenericObject>:
